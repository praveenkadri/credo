...
export function CompanyAuthorizationStep({
  values,
  onChange,
}: {
    ...
    <div className="space-y-4">
      <Field label="Director name">
        <Input
          ...
          onChange={(event) => onChange("directorName", event.target.value)}
      ...
      <Field label="Director title">
        <Input
          ...
          onChange={(event) => onChange("directorTitle", event.target.value)}
          className={FIELD_CLASS}
        />
      </Field>
    </div>
