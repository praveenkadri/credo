...
export const surfaceVariants = {
  softGlass: "rounded-[24px] bg-white/55 ring-1 ring-neutral-200/40",
  accountRow:
    "rounded-[24px] bg-white/55 ring-1 ring-neutral-200/40 shadow-[0_8px_30px_rgba(15,23,42,0.035)]",
  rightRailCard:
