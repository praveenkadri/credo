      ...
      <div className="flex min-w-0 flex-1 items-center justify-between gap-3">
        <div className="relative min-w-0 shrink-0" ref={menuRef}>
          <button
            ...
            className="type-button inline-flex h-10 max-w-[260px] items-center gap-2 rounded-full bg-[#f6f5f0] px-2.5 pr-3 text-[#575b55] transition-all duration-[160ms] ease-[cubic-bezier(0.2,0,0,1)] hover:bg-[#f1f0ea] hover:text-[#1f221c] active:scale-[0.98] active:duration-[90ms] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-300/40 motion-reduce:active:scale-100"
          >
            <Avatar initials={selectedCompany?.initials ?? "C"} compact />
            <span className="truncate text-[#1f221c]">
              {selectedCompany?.name ?? c.topbar.workspaceName}
            </span>
            <span className="type-caption text-neutral-500">▾</span>
          </button>
            ...
            >
                  ...
                  {companies.map((company) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="type-body-small min-w-0 flex-1 truncate text-[#1f221c]">{company.name}</span>
                        {isCurrent ? <span className="type-caption text-neutral-500">{c.common.current}</span> : null}
                      </button>
                    );
                  })}
                </div>
              ...
              <div className="mt-1 border-t border-neutral-200/70 pt-1">
                <Link
                  ...
                  className="type-button flex h-9 items-center rounded-2xl px-2 text-neutral-700 transition-colors duration-[160ms] ease-[cubic-bezier(0.2,0,0,1)] hover:bg-neutral-100/70 hover:text-neutral-900"
                >
                  {c.topbar.addCompany}
                </Link>
                <Link
